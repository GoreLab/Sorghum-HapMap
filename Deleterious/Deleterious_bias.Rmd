...
daf <- read.delim( file = "/workdir/rjl278/Sorghum/Evol_model/Derived_alleles/splitting/FULL.DAF", header =  T) %>%
...
fracs <- read.delim("/workdir/rjl278/Maize/Comparative_Hapmap/DEL/Maize.fractionation", header = T, stringsAsFactors = FALSE)
...
##
Ready_maize <- rbind(ancestral, derivao) %>%
